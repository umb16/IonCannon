...
namespace EMX.HierarchyPlugin.Editor
{
	class Cache
	{
		...
		internal static TempColorClass LOAD_CUSTOM_ICON_USING_HIGHLIGHTER()
		{
			return null;
		}
		...
		internal static void ClearHierarchyObjects(bool full = true)
        ...
        */
		...
		static Dictionary<int, HierarchyObject> m_instanceIdToHierObject = new Dictionary<int, HierarchyObject>();
		...
		static void ON_GUID_BACKCHANGED()
		{
			...
			Root.p[1].PUSH_GUI_ONESHOT(() =>
			 {
				 Root.p[1].Modules_SetDirty();
				 Root.p[1].Modules_RefreshBookmarks();
		...
		static internal HierarchyObject GetHierarchyObjectByGUID(UnityEngine.Object ob)
		{
			...
			if (!m_instanceIdToHierObject.TryGetValue(instanceid, out gettedObject))
			{
				string finded = "-";
				string f_path = "-";
		...
		static internal HierarchyObject GetHierarchyObjectByGUID(ref string guid, ref string estimpath)
		{
