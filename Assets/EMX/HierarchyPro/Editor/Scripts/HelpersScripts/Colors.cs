...
namespace EMX.HierarchyPlugin.Editor
{
    ...
    class Colors
    {
        ...
        internal static void UpdateColorsBefore_OnGUI( PluginInstance p )
        {
            ...
            //HOVER
            if ( p.hierarchyModification.hoveredBackgroundColor.HasValue )
            {
                HoverColor = Color.Lerp( EditorBGColor, new Color( p.hierarchyModification.hoveredBackgroundColor.Value.r, p.hierarchyModification.hoveredBackgroundColor.Value.g, p.hierarchyModification.hoveredBackgroundColor.Value.b, 1 ),
                         p.hierarchyModification.hoveredBackgroundColor.Value.a );
            }
            else
            {
        ...
        internal class ColorList
        {
            ...
            internal Color32 color
            {
                ...
                set { Root.p[ 0 ].par_e.SET( key + index, value ); }
            }
        }
        ...
        internal static bool Eq( ref Color32 a, ref Color32 b )
        {
            return a.r == b.r &&
                a.g == b.g &&
                a.b == b.b &&
