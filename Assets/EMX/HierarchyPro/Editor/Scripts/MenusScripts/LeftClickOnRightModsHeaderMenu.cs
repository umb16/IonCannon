...
namespace EMX.HierarchyPlugin.Editor
{
    class LeftClickOnRightModsHeaderMenu
    {
        ...
        internal static void Open( bool addMenu = false, Action<GenericMenu> topBuilder = null )
        {
            ...
            menu.AddItem( new GUIContent( "[ Open Modules Table ☷ ]" ), false, ( ) => { Windows.ModulesWindow.Init( pos, p ); } );
        ...
        static void CONTEXTMENU_STATICMODULES( GenericMenu menu )
        {
            ...
            cont = new GUIContent( "- " + p.modsController.playModeKeeperMod.HeaderText.ToString() + " -" );
        ...
        static void ADD_LAYOUTS( ref GenericMenu menu )
        {
            ...
            if ( findIndex != -1 ) menu.AddDisabledItem( new GUIContent( CATEGORY + "Add" ) );
                ...
                menu.AddItem( new GUIContent( CATEGORY + "Add" ), false, ( ) =>
                   {
                       Windows.InputWindow.Init( pos, "New Item", p, ( str ) =>
                 {
            ...
            for ( int i = 0 ; i < saved_states.Count ; i++ )
            {
                ...
                menu.AddItem( new GUIContent( CATEGORY + captureName ), findIndex == i, ( ) => { SetDirtyModulesSnapShots( captureName, captureSnap ); } );
            }
        ...
        static void SetDirtyModulesSnapShots( string name, string data )
        {
