...
namespace EMX.HierarchyPlugin.Editor.Mods
{
	...
	public abstract class ExternalModRoot : EditorWindow
	{
		...
		internal ExternalDrawContainer __controller = new ExternalDrawContainer();
		internal ExternalDrawContainer controller { get { return __controller ?? (__controller = new ExternalDrawContainer()); } }
		Events.MouseRawUp _mouse_uo_helper;
		internal PluginInstance adapter { get { return Root.p[0]; } }
		internal Events.MouseRawUp mouse_uo_helper { get { return _mouse_uo_helper ?? (_mouse_uo_helper = new Events.MouseRawUp(adapter)); } }
