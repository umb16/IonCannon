    ...
    partial class HyperGraphModInstance 
    {
        ...
        private FieldsAccessor GetReflectionFields(UnityEngine.Object comp, ObjectDisplay callbackobject = null)
        {
            if (FiledsInfo == null)
                ...
                {
                    {typeof(Transform), new FieldsAccessor(this, typeof(Transform)) {completed_thead = true, faList = new Tools.FieldAdapter[0]}},
                    {typeof(CanvasRenderer), new FieldsAccessor(this, typeof(CanvasRenderer)) {completed_thead = true, faList = new Tools.FieldAdapter[0]}}
                };
        ...
        class JobFactory
        {
            ...
            class JobInstance
            {
                ...
                internal void mh_Action()
                {
                    ...
                    {
                        LogProxy.LogError("HyperThead " + ex.Message + " " + ex.StackTrace);
                    }
