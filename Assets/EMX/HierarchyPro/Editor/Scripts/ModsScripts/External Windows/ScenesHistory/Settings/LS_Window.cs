...
namespace EMX.HierarchyPlugin.Editor.Settings
{
    ...
    class LastScenesHistorySettingsEditor : MainRoot
    {

        internal static string set_text = "Use Scenes History";
        ...
        public override void OnInspectorGUI( )
        {
            ...
            Draw.HELP("Use left-click to pin button.", drawTog: true);
