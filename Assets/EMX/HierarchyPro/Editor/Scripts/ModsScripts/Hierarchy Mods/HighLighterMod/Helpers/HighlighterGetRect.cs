...
namespace EMX.HierarchyPlugin.Editor.Mods
{
	class HighlighterGetRect
	{
		...
		internal static Rect GetIconRectIfNextToLabel(Rect selectionRect, GetIconRectIfNextToLabelType type)
		{
			...
			TryToFaeBG_Rect.ref_selectionRect.x += adapter.hierarchyModification.LEFT_PADDING;
			// TryToFaeBG_Rect.HasIcon = adapter._S_bgIconsPlace == 0;
			TryToFaeBG_Rect.adapter = adapter;
			TryToFaeBG_Rect.HasIcon = true;
			TryToFaeBG_Rect.MinLeft = adapter.hierarchyModification.LEFT_PADDING;
		...
		static internal Rect GetIconRect(Rect selectionRect, bool callFromExternal, int? overrideValue = null, int? overrideSBGIconPlace = null)
		{
