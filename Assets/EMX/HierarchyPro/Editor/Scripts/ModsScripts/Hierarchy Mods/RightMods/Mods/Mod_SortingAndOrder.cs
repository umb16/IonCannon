...
#pragma warning restore
			if ( r && EVENT.button == adapter.MOUSE_BUTTON_0)
			{
				...
				menu.AddItem( new GUIContent( "+ Assign a New SortingLayer" ), false, ( ) =>
				   {
					   Windows.InputWindow.Init( pos, "New SortingLayer name's", adapter, ( str ) =>
					 {
...
#pragma warning restore
			if ( r && EVENT.button == adapter.MOUSE_BUTTON_0)
			{
				...
				Windows.InputWindow.InitTeger( pos, "Sorting Order", adapter, act, null, r.sortingOrder.ToString() );
			}
