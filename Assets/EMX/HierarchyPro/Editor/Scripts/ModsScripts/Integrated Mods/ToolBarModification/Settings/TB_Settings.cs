...
namespace EMX.HierarchyPlugin.Editor
{
	...
	partial class EditorSettingsAdapter
	{
		...
		internal bool TOPBAR_LAYOUTS_SAVE_ONLY_CUSTOM { get { return GET("TOPBAR_LAYOUTS_SAVE_ONLY_CUSTOM", false); } set { SET("TOPBAR_LAYOUTS_SAVE_ONLY_CUSTOM", value); p.RepaintAllViews(); } }
