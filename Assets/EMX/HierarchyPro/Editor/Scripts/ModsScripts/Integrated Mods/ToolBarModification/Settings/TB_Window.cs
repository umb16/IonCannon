...
namespace EMX.HierarchyPlugin.Editor.Settings
{
	...
	class TopBarsModSettingsEditor : MainRoot
	{
		...
		internal static string set_text = "Use TopBar";
		...
		public override void OnInspectorGUI()
		{
			...
			using (ENABLE.USE(set_key))
			{
				...
				using (GRO.UP(0))
				{
					...
					Draw.TOG_TIT("Draw External Mods HotButtons on TopBar", "DRAW_TOPBAR_HOTBUTTONS");
				...
				using (GRO.UP(0))
				{
					Draw.TOG_TIT("Use Custom Left Side Buttons", "DRAW_TOPBAR_CUSTOM_LEFT");
					Draw.HELP("You can add your buttons at the top bars, using EMX." + Root.CUST_NS + "");
					Draw.TOG_TIT("Use Custom Right Side Buttons", "DRAW_TOPBAR_CUSTOM_RIGHT");
					Draw.HELP("You can add your buttons at the top bars, using EMX." + Root.CUST_NS + "");
				}
