...
namespace EMX.HierarchyPlugin.Editor
{
	...
	internal partial class PluginInstance
	{
		...
		internal void REBUILD_EDITOR_EVENTS(EditorSubscriber sbs)
		{
			...
			BuildedOnGUI_first = sbs.BuildedOnGUI_first;
			BuildedOnGUI_middle = sbs.BuildedOnGUI_middle;
			BuildedOnGUI_last = sbs.BuildedOnGUI_last;
			BuildedOnGUI_last_butBeforeGL = sbs.BuildedOnGUI_last_butBeforeGL;
