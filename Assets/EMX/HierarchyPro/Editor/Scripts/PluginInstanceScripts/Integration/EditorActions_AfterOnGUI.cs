...
using R = EMX.HierarchyPlugin.Editor.Root;
...
namespace EMX.HierarchyPlugin.Editor
{
	...
	internal partial class PluginInstance
	{
		...
		bool MultyLineOffsetUpDown()
		{
			...
			{
				Debug.LogError("[" + Root.PN + "] Multi-selection caused an error, disable this option in the settings\n\n" + ex.Message + "\n\n" + ex.StackTrace);
				return false;
			}
