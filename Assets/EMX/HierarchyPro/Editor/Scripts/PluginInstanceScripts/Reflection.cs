...
namespace EMX.HierarchyPlugin.Editor
{
    internal partial class PluginInstance
    {
        ...
        void Init()
        {
            ...
            #region R
            _TreeViewController = SceneHierarchyWindow.GetField("m_treeView", ~(BindingFlags.Static | BindingFlags.InvokeMethod));
            if (_TreeViewController == null) if ((_TreeViewController = SceneHierarchyWindow.GetField("m_TreeView", ~(BindingFlags.Static | BindingFlags.InvokeMethod))) == null) throw new Exception("m_TreeView");
            //  if (pluginID != 0)
            {
            ...
            if ((hierwin_DuplicateGO = SceneHierarchyWindow.GetMethod("DuplicateGO", ~(BindingFlags.Static | BindingFlags.SetField))) == null) throw new Exception("DuplicateGO");
