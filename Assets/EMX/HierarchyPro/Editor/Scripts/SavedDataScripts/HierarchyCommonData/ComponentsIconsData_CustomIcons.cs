...
namespace EMX.HierarchyPlugin.Editor
{
    ...
    internal class DrawCustomIconsClassOld
    {
     ...
     //   internal const float IC_H = 36;
        ...
        internal List<string> customIcons { get { return HierarchyCommonData.Instance().GetCustomIconsLeyslist(); } set { HierarchyCommonData.Instance().PutCustomIconsLeyslist(value); } }
