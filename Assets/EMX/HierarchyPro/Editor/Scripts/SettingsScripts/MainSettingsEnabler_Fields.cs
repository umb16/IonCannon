...
namespace EMX.HierarchyPlugin.Editor
{
	...
	partial class EditorSettingsAdapter
	{
		...
		internal bool USE_BACKGROUNDDECORATIONS_MOD { get { return HardDisableMods.USE_BACKGROUNDDECORATIONS_MOD ?? GET("USE_BACKGROUNDDECORATIONS_MOD", true); } set { if (SET("USE_BACKGROUNDDECORATIONS_MOD", value)) p.modsController.REBUILD_PLUGINS(); } }
		...
		internal bool USE_MANUAL_HIGHLIGHTER_MOD { get { return HardDisableMods.USE_MANUAL_HIGHLIGHTER_MOD ?? GET("USE_MANUAL_HIGHLIGHTER_MOD", true); } set { if (SET("USE_MANUAL_HIGHLIGHTER_MOD", value)) p.modsController.REBUILD_PLUGINS(); } }
		internal bool USE_AUTO_HIGHLIGHTER_MOD { get { return HardDisableMods.USE_AUTO_HIGHLIGHTER_MOD ?? GET("USE_AUTO_HIGHLIGHTER_MOD", true); } set { if (SET("USE_AUTO_HIGHLIGHTER_MOD", value)) p.modsController.REBUILD_PLUGINS(); } }
