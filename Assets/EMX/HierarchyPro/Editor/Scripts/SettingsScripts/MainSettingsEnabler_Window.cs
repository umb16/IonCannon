...
namespace EMX.HierarchyPlugin.Editor.Settings
{
	class MainSettingsEnabler_Window : ScriptableObject
	{
		...
		internal static void CheckSettings()
		{
			...
			_Check<SA_Window>(Folders.PluginInternalFolder + "/Editor/Settings/" + ModsSettings + "Hierarchy Mods/GameObjectSetActiveModSettings.asset");
			_Check<PK_Window>(Folders.PluginInternalFolder + "/Editor/Settings/" + ModsSettings + "Hierarchy Mods/PlayModeSaverModeSettings.asset");
			_Check<RM_Window>(Folders.PluginInternalFolder + "/Editor/Settings/" + ModsSettings + "Hierarchy Mods/RightHierarchyModsSettings.asset");
			_Check<HLM_Window>(Folders.PluginInternalFolder + "/Editor/Settings/" + ModsSettings + "Hierarchy Mods/HighlighterManualModSettings.asset");
			_Check<HLA_Window>(Folders.PluginInternalFolder + "/Editor/Settings/" + ModsSettings + "Hierarchy Mods/HighlighterAutoModSettings.asset");
			_Check<IC_Window>(Folders.PluginInternalFolder + "/Editor/Settings/" + ModsSettings + "Hierarchy Mods/IconsForComponentsModSettings.asset");
			_Check<PM_Window>(Folders.PluginInternalFolder + "/Editor/Settings/" + ModsSettings + "Hierarchy Mods/PresetsManagerModSettings.asset");
			_Check<PW_Window>(Folders.PluginInternalFolder + "/Editor/Settings/" + ModsSettings + "Hierarchy Mods/ProjectWindowSettings.asset");
	...
	class MainSettingsEditor : MainRoot
	{
		...
		public override void OnInspectorGUI()
		{
			...
			using (ENABLE.USE("ENABLE_ALL", 0))
			{
				...
				Draw.TOG_TIT("Main Hierarchy Settings", rightOffset: 1); if (Draw.BUT(Draw.last, "Main Hierarchy Settings")) { MainSettingsEnabler_Window.Select<MainSettingsParams_Window>(); }
			...
			GUI.Button(Draw.R2, "Hierarchy Mods", Draw.s("preToolbar"));
			GUI.color = C;
			/*	using (GRO.UP())
				{
