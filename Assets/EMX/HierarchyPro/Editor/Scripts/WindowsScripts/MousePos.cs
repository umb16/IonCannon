...
namespace EMX.HierarchyPlugin.Editor
{
        ...
        internal static Dictionary<Type, WindowParams> w_params = new Dictionary<Type, WindowParams>()
    {
        ...
        internal static Rect WidnwoRect( MousePos? _mouse, float width, float height, PluginInstance adapter, MousePos? savePosition = null
        /*, bool lockPos = false*/
        ) //if (!lockPos) width *= adapter.HALFFACTOR_8();
        {
            ...
            var hierWin = adapter.window.Instance;
            ...
            { // if (height > hierWin.position.height - 45) height = hierWin.position.height - 65;
                ...
                var max = Windows.IWindow.MAX_HEIGHT(adapter);
