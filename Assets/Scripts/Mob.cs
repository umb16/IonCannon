...
public class Mob : MonoBehaviour
{
    ...
    private readonly List<GameObject> _listOfChilds = new List<GameObject>();
    ...
    private void CreateChild()
    {
        if (_listOfChilds.Count < 5)
        {
            ...
            GameObject gameObject = UnityEngine.Object.Instantiate(Child, new Vector3(vector.x, vector.y, -0.5f), Quaternion.identity);
            ...
            if (UnityEngine.Random.value < 0.05f)
            {
                ...
                component.Hp *= 1.5f;
                component.ScoreCost = (int)(component.ScoreCost * 1.5f);
            }
        }
        else
        {
    ...
    private void DmgCheck(int type)
    {
        if (Hp <= 0f)
        {
            ...
            Score.CurrentScore += (int)(ScoreCost * (1f + 0.1f * ComboCount));
            ComboCount++;
